...
public class Employee implements Serializable {
    private String _id,name,position,_idDepartment,avatar,name_department;
    ...
    public Employee(String _id, String name, String _idDepartment, String avatar, int workdays, int salary) {
        this._id = _id;
        this.name = name;
        this._idDepartment = _idDepartment;
        this.avatar = avatar;
